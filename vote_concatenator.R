...
#write.csv2(Senate_Votes, "./louisville-hackathon-mar2017/Senate_Votes.csv", quote = F, row.names = F)
#write.csv2(House_Votes, "./louisville-hackathon-mar2017/House_Votes.csv", quote = F, row.names = F)
